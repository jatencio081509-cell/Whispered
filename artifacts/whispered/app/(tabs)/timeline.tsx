...
const styles = StyleSheet.create({
  ...
  eventCard: { flexDirection: "row", paddingVertical: 16, gap: 16 },
  ...
  eventDate: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
  eventTitle: { fontSize: 16, fontFamily: "Inter_600SemiBold" },
  eventDescription: { fontSize: 14, fontFamily: "Inter_400Regular", lineHeight: 20 },
